...
export const getButtonColor = (color, isOutlined, hasHover, isActive = false) => {
	const colors = {
		...
		bgHover: {
			...
			success: "hover:bg-green-700 hover:border-green-700 hover:dark:bg-green-600 hover:dark:border-green-600",
		...
		outlineHover: {
			...
			success: "hover:bg-green-600 hover:text-white hover:text-white hover:dark:text-white hover:dark:border-green-600",
