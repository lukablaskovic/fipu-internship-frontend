...
<template>
    <li>
        <component 
            ...
            v-slot="vSlot" :is="item.to ? RouterLink : 'a'" @click="menuClick"
            ...
            <span class="transition-all duration-300 text-clip line-clamp-1"
                :class="[{ '': isCompact, '': !hasSub },
                        ...
                        item.color == 'info' ? 'text-slate-900 font-medium hover:underline' : '']">
                        {{ item.label }}
            </span>
