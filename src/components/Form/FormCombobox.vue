<template>
  <Combobox v-model="selected">
    <div class="relative z-50">
      <div
        class="relative w-full cursor-default overflow-hidden rounded bg-white text-left sm:text-sm border border-gray hover:border-fipu_blue focus:border-fipu_blue"
      >
        <ComboboxInput
          class="w-full px-3 py-2 max-w-full focus:ring focus:outline-none dark:placeholder-gray-400 h-12 dark:bg-slate-800"
          :display-value="(company) => company.label"
