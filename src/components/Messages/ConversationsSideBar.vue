...
<template>
	<div class="flex flex-row flex-shrink-0 bg-gray-100 dark:bg-gray-900 p-4 absolute lg:relative h-full min-w-[256px] w-96 transition-all duration-500 lg:duration-0 z-20" :class="[chatStore.collapsed ? '-left-96 lg:-left-0' : '-left-0']">
