...
<template>
	<div class="flex gap-3 items-end" :class="{ 'flex-row-reverse': reverse }">
		<div :class="!reverse ? 'bg-fipu_blue' : 'bg-rose-600/70 dark:bg-rose-500/75'" class="flex items-center justify-center h-9 w-9 rounded-full text-white dark:text-fipu_gray dark:font-bold font-medium flex-shrink-0">
			{{ user[0] }}
		</div>
