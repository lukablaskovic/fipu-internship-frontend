...
<template>
	<div class="flex flex-row items-center px-3 py-3 bg-gray-200 dark:bg-slate-900/50">
		<input v-if="chatStore.c.status != 'archived'" @input="checkNewMessage()" v-model="chatStore.content" type="text" class="border-none bg-transparent focus:outline-none text-sm items-center w-full border text-fipu_gray dark:text-gray-300 bg-white hover:bg-gray-50 focus:bg-white dark:bg-slate-800 dark:hover:bg-slate-700/40 dark:focus:bg-slate-800 rounded-3xl h-12 px-6" placeholder="Type your message...." />
