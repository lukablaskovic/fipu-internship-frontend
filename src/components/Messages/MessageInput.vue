...
<template>
    <div class="flex flex-row items-center lg:px-3 py-3 bg-gray-200 dark:bg-slate-900/50">
        <input v-model="chatStore.content" type="text" class="border-none bg-transparent focus:outline-none text-sm items-center w-full border text-fipu_gray dark:text-gray-300
