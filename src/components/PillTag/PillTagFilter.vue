        ...
        >
          ...
          >
            <button
              :class="[
                option.label === 'Spremi'
                  ? 'hover:bg-emerald-600 dark:hover:bg-emerald-500 hover:font-bold hover:text-slate-100 dark:hover:text-gray-950'
                  : active && option.label != 'Resetiraj'
                  ? 'bg-gray-300 dark:bg-gray-900'
                  : '',
                selectedOptions.includes(option.label)
                  ? 'bg-fipu_blue hover:bg-fipu_light_blue dark:hover:bg-fipu_dark_blue font-medium text-gray-950 hover:text-slate-800 dark:hover:text-gray-950'
                  : '',
                option.label === 'Resetiraj'
                  ? 'dark:hover:bg-rose-600 hover:bg-rose-500 hover:font-bold hover:text-slate-100 dark:hover:text-slate-950'
                  : '',
