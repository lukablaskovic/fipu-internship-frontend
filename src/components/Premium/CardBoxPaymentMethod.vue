	...
	<CardBox class="mb-6">
		<div class="md:flex md:justify-between md:items-center">
			<div class="flex justify-start items-center mb-6 md:mb-0">
				...
				<div class="mr-6">
					<h2 class="text-xl font-semibold">{{ cardTypeName }} {{ cardNumber }}</h2>
					<p class="text-gray-500 text-sm uppercase">{{ cardExpires }} {{ cardOwner }}</p>
				</div>
				<PillTag v-if="isPrimary" color="info" :icon="mdiCreditCardCheck" label="Primary" small />
			</div>
