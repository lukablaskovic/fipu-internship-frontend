...
<template name="fade"> 
    <div :class="{dark: styleStore.darkMode, 'overflow-hidden lg:overflow-visible': layoutStore.isAsideMobileExpanded}">
        <div :class="[layoutAsidePadding, { 'ml-60 lg:ml-0': layoutStore.isAsideMobileExpanded }]" 
            ...
            <CardBoxModal has-cancel :has-confirm="false" v-model="helpModalActive" title="ℹ️ Upute za izvođenje prakse" button-label="Povratak"
                ...
                <ol class="list-decimal ml-4">
                    ...
                    <li>
                        <div class="flex flex-wrap text-base">
                            ...
                            <span class="text-fipu_blue cursor-pointer inline-flex whitespace-normal items-center"
