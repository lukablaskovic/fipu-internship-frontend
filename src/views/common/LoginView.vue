  ...
  <SectionSplitLogin bg="blue" class="flex items-start min-h-screen">
        <Transition appear enter-active-class="animate__animated animate__fadeIn" 
            ...
            <div v-if="!transitioning" class="flex flex-col justify-center items-center overflow-hidden h-screen || md:py-16 md:px-4 || transition-all duration-300">
                <div class="flex flex-col md:flex-row flex-shrink h-full || bg-white rounded-lg overflow-hidden || transition-all duration-300 px-0 lg:px-6 xl:px-16 2xl:pr-28 2xl:pl-20 || xl:gap-4 2xl:gap-8">
                    <CardBox class="hidden xl:block flex-1 bg-opacity-0 grow p-16 xl:px-0 xl:py-16 2xl:py-24 || transition-all duration-300"
                        centered-content>
                    ...
                    <CardBox class="flex flex-col flex-shrink flex-1 bg-opacity-0 p-8 sm:p-16 xl:pl-2 xl:px-0 xl:py-24 || transition-all duration-300"
                        ...
                        <a class="hover-underline-animation cursor-pointer text-fipu_text_blue hover:text-fipu_blue"
                        ...
                        <FormField label="E-mail">
                            <FormControl v-model="loginForm.email" :icon="mdiAccount" name="email" autocomplete="email" :error="getFirstErrorForField('email')">
                            </FormControl>
                        </FormField>
