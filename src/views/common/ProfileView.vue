...
const rules = {
  ...
  password: {
    sameAs: helpers.withMessage(
      "Nova lozinka ne smije biti identična staroj",
      not(sameAs(password_current))
    ),
    required: helpers.withMessage("Polje je obavezno", required),
...
async function onSubmit() {
  ...
  let response = await mainStore.updatePassword(
  ...
  switch (type) {
    ...
    case "warning":
      ...
      notificationMessage.value =
        " Pogrešna stara lozinka. Molimo pokušajte ponovno.";
      break;
  }
    ...
    <SectionMain>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <CardBox is-form class="rounded">
          ...
          <FormField
            v-if="profileForm.account_type != 'student'"
        ...
        <CardBox is-form class="rounded" @submit.prevent="onSubmit">
          ...
          >
            <FormControl
              ...
              :icon="mdiAsterisk"
              :error="getFirstErrorForField('password_current')"
          ...
          >
            <FormControl
              ...
              :icon="mdiFormTextboxPassword"
              required
              :error="getFirstErrorForField('password_confirmation')"
              type="password"
